...
#     path('deposit_list/<str:fin_prdt_cd>/', views.deposit_detail),
#     path('deposit_list/<str:fin_prdt_cd>/Option_list/', views.depositOption_list),
#     path('deposit_list/<str:fin_prdt_cd>/Option_list/<int:depositOption_pk>/', views.depositOption_detail),
...
#     path('deposit_list/<str:fin_prdt_cd>/contract/', views.contract_deposit, name='contract_deposit'),
...
urlpatterns = [
    ...
    path('deposit_list/<str:fin_prdt_cd>/Option_list/', views.depositOption_list),
    path('deposit_list/<str:fin_prdt_cd>/Option_list/<int:depositOption_pk>/', views.depositOption_detail),
    path('saving_list/', views.saving_list),  # 수정: 적금 목록 엔드포인트 추가
    path('saving_list/<str:saving_code>/', views.saving_detail),  # 수정: 적금 세부 정보 엔드포인트 추가
    path('saving_list/<str:saving_code>/Option_list/', views.savingOption_list),  # 수정: 적금 옵션 목록 엔드포인트 추가
    path('saving_list/<str:saving_code>/Option_list/<int:savingOption_pk>/', views.savingOption_detail),  # 수정: 적금 옵션 세부 정보 엔드포인트 추가
    path('deposit/6months/', views.get_deposits, {'save_trm': '6'}),
    path('deposit/12months/', views.get_deposits, {'save_trm': '12'}),
    path('deposit/24months/', views.get_deposits, {'save_trm': '24'}),
    path('deposit/36months/', views.get_deposits, {'save_trm': '36'}),
    ...
    path('saving/-36months/', views.get_reverse_savings, {'save_trm': '36'}),
    path('deposit_list/<str:fin_prdt_cd>/contract/', views.contract_deposit, name='contract_deposit'),
    path('saving_list/<str:fin_prdt_cd>/contract/', views.contract_saving, name='contract_saving'),
    path('get_bank_deposit/<str:kor_co_nm>/', views.get_bank_deposit),
    path('get_bank_saving/<str:kor_co_nm>/', views.get_bank_saving),
    path('recommend_product_one/', views.recommend_product_one),
    path('recommend_product_two/', views.recommend_product_two),
