    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_img', models.ImageField(default='images/user.png', upload_to='users/')),
                ('financial_products', models.TextField(blank=True, null=True)),
                ('age', models.IntegerField(blank=True, null=True)),
                ('now_money', models.IntegerField(blank=True, null=True)),
                ('money_per_year', models.IntegerField(blank=True, null=True)),
                ...
                ('fav_place', models.CharField(blank=True, max_length=100, null=True)),
                ('is_superuser', models.BooleanField(default=False)),
                ('deposits', models.ManyToManyField(blank=True, related_name='users', to='compare.deposit')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('savings', models.ManyToManyField(blank=True, related_name='users', to='compare.saving')),
